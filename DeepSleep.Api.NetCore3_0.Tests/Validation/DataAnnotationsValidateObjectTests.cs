namespace DeepSleep.Api.NetCore.Tests.Validation
{
    ...
    public class DataAnnotationsValidateObjectTests : PipelineTestBase
    {
        [Fact]
        public async Task validateobject___correctly_validates_invalid_uri_model()
        {
            base.SetupEnvironment();

            var request = @$"
POST https://{host}/validators/validateobject/uri/and/body/2020 HTTP/1.1
...
{{
    ""Value"": ""Test""
        ...
        [Fact]
        public async Task validateobject___correctly_validates_invalid_uri_model_with_invalid_body()
        {
            base.SetupEnvironment();
...
{{
    ""Value"": ""2020""
        ...
        [Fact]
        public async Task validateobject___correctly_validates_invalid_body_model()
        {
            base.SetupEnvironment();

            var request = @$"
POST https://{host}/validators/validateobject/uri/and/body/TEST HTTP/1.1
Accept: {applicationJson}
Content-Type: {applicationJson}
...
{{
    ""Value"": ""2020""
        ...
        [Fact]
        public async Task validateobject___correctly_validates_endpoint_when_uri_and_body_valid()
        {
            base.SetupEnvironment();
