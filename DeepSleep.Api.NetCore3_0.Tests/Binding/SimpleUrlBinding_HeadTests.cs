...
X-CorrelationId: {correlationId}";
        ...
        [Theory]
        [InlineData("CharVar", "aa", 168)]
        [InlineData("NullCharVar", "aa", 183)]
        [InlineData("Int16Var", "a", 169)]
        [InlineData("NullInt16Var", "a", 183)]
        [InlineData("UInt16Var", "a", 171)]
        [InlineData("UInt16Var", "-1", 172)]
        [InlineData("NullUInt16Var", "a", 184)]
        [InlineData("NullUInt16Var", "-1", 185)]
        [InlineData("Int32Var", "a", 169)]
        [InlineData("NullInt32Var", "a", 183)]
        [InlineData("UInt32Var", "a", 171)]
        [InlineData("UInt32Var", "-1", 172)]
        [InlineData("NullUInt32Var", "a", 184)]
        [InlineData("NullUInt32Var", "-1", 185)]
        [InlineData("Int64Var", "a", 169)]
        [InlineData("NullInt64Var", "a", 183)]
        [InlineData("UInt64Var", "a", 171)]
        [InlineData("UInt64Var", "-1", 172)]
        [InlineData("NullUInt64Var", "a", 184)]
        [InlineData("NullUInt64Var", "-1", 185)]
        [InlineData("DoubleVar", "a", 171)]
        [InlineData("NullDoubleVar", "a", 184)]
        [InlineData("DecimalVar", "a", 173)]
        [InlineData("NullDecimalVar", "a", 185)]
        [InlineData("FloatVar", "a", 170)]
        [InlineData("NullFloatVar", "a", 183)]
        [InlineData("BoolVar", "a", 170)]
        [InlineData("NullBoolVar", "a", 182)]
        [InlineData("DateTimeVar", "a", 175)]
        [InlineData("NullDateTimeVar", "a", 186)]
        [InlineData("DateTimeOffsetVar", "a", 187)]
        [InlineData("NullDateTimeOffsetVar", "a", 192)]
        [InlineData("TimeSpanVar", "a", 175)]
        [InlineData("NullTimeSpanVar", "a", 186)]
        [InlineData("ByteVar", "a", 167)]
        [InlineData("NullByteVar", "a", 182)]
        [InlineData("SByteVar", "a", 169)]
        [InlineData("NullSByteVar", "a", 183)]
        [InlineData("GuidVar", "a", 167)]
        [InlineData("NullGuidVar", "a", 182)]
        [InlineData("EnumVar", "a", 183)]
        [InlineData("NullEnumVar", "a", 182)]
