namespace DeepSleep.Api.Web.Tests.Discovery
{
    ...
    public class AttributeDiscovery_DeprecatedTests : PipelineTestBase
    {
        [Fact]
        public async Task discovery_attribute___deprecated_not_specified_defaults_correctly()
        {
            ...
            var request = @$"
GET https://{host}/discovery/attribute/deprecated HTTP/1.1
Host: {host}
Accept: {applicationJson}";
        ...
        public async Task discovery_attribute___deprecated_false_correctly()
        {
            ...
            var correlationId = Guid.NewGuid();
            var request = @$"
GET https://{host}/discovery/attribute/deprecated/false HTTP/1.1
Host: {host}
Accept: {applicationJson}";
        ...
        public async Task discovery_attribute___deprecated_true_correctly()
        {
            ...
            var correlationId = Guid.NewGuid();
            var request = @$"
GET https://{host}/discovery/attribute/deprecated/true HTTP/1.1
Host: {host}
Accept: {applicationJson}";
