namespace DeepSleep.Tests
{
    ...
    public class LanguageValueWithQualityTests
    {
        [Fact]
        public void languagevaluewithquality___returns_tostring_with_parameters()
        {
            var value = new LanguageValueWithQuality("iso", 1, new List<string>
            {
                "p1=testparam1",
                "q=2.0",
                "p2=testparam2"
