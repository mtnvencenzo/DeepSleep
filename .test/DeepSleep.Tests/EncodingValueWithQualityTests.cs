namespace DeepSleep.Tests
{
    ...
    public class EncodingValueWithQualityTests
    {
        [Fact]
        public void encodingvaluewithquality___returns_tostring_with_parameters()
        {
            var value = new EncodingValueWithQuality("iso", 1, new List<string>
            {
                "p1=testparam1",
                "q=2.0",
                "p2=testparam2"
