namespace DeepSleep.OpenApi.Decorators
{
    ...
    public class OasOperationAttribute : Attribute
    {
        /// <summary>Initializes a new instance of the <see cref="OasOperationAttribute" /> class.</summary>
        /// <param name="operationId">The operation identifier.</param>
        /// <param name="tags">The tags.</param>
        public OasOperationAttribute(string operationId, string[] tags = null)
        {
