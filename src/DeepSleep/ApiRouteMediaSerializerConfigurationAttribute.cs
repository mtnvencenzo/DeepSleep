namespace DeepSleep
{
    ...
    public class ApiRouteMediaSerializerConfigurationAttribute : Attribute
    {
        /// <summary>Initializes a new instance of the <see cref="ApiRouteMediaSerializerConfigurationAttribute"/> class.</summary>
        ...
        public ApiRouteMediaSerializerConfigurationAttribute(string acceptHeaderOverride = null, string[] readableMediaTypes = null, string[] writeableMediaTypes = null)
        {
