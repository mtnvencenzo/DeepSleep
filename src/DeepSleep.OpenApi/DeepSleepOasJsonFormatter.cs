namespace DeepSleep.OpenApi
{
    ...
    public class DeepSleepOasJsonFormatter : DeepSleepMediaSerializerBase
    {
        private readonly IApiRequestContextResolver contextResolver;

        /// <summary>Initializes a new instance of the <see cref="DeepSleepOasJsonFormatter"/> class.</summary>
        /// <param name="contextResolver">The context resolver.</param>
        public DeepSleepOasJsonFormatter(IApiRequestContextResolver contextResolver)
        {
