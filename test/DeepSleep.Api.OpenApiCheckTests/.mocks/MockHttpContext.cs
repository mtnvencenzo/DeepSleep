namespace DeepSleep.Api.OpenApiCheckTests.Mocks
{
    ...
    public class MockHttpContext : HttpContext, IDisposable
    {
        ...
        public MockHttpContext(IServiceProvider serviceProvider, HttpRequestMessage request, bool includeContentLength = true)
        {
            ...
            this.httpRequest = MockHttpRequest.FromHttpRequestMessage(this, request, includeContentLength);
