namespace Api.DeepSleep.Web.WebApiCheck.Controllers
{
    ...
    [ApiController]
    [Route("[controller]")]
    public class BasicObjectEndpointsController : ControllerBase
    {
        ...
        /// </remarks>
        [HttpPost]
        [Route(template: "/basic/object/model/no/doc/attributes/{id}", Name = "PostBasicObjectModelNoDocAttributes")]
        public BasicObject PostBasicObjectModelNoDocAttributes([FromBody] BasicObject request, int id)
        {
